...
I do not use nor do I condone the use of illegal drugs and substances! The sole purpose of this application is to showcase the tools used. [The Strain Api](http://strains.evanbusse.com/) was used because I liked how the JSON data looked and I felt it would make for an interesting project.
